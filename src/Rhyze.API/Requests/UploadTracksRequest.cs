...
{
    public class UploadTracksRequest : RequireAnOwner, IRequest<IEnumerable<UploadResult>>
    {
    ...
    public class UploadTracksRequestHandler : IRequestHandler<UploadTracksRequest, IEnumerable<UploadResult>>
    {
        private readonly IUploadService _uploadService;

        public UploadTracksRequestHandler(IUploadService uploadService) => _uploadService = uploadService;

        public async Task<IEnumerable<UploadResult>> Handle(UploadTracksRequest request, CancellationToken cancellationToken)
        {
